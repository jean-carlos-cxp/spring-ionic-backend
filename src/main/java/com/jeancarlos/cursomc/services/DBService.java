...
import com.jeancarlos.cursomc.domain.Pagamento;
import com.jeancarlos.cursomc.domain.PagamentoComBoleto;
import com.jeancarlos.cursomc.domain.PagamentoComCartao;
...
import com.jeancarlos.cursomc.domain.enums.Perfil;
import com.jeancarlos.cursomc.domain.enums.TipoCliente;
...
import com.jeancarlos.cursomc.repositories.EnderecoRepository;
import com.jeancarlos.cursomc.repositories.EstadoRepository;
import com.jeancarlos.cursomc.repositories.ItemPedidoRepository;
import com.jeancarlos.cursomc.repositories.PagamentoRepository;
import com.jeancarlos.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jean.silva0096@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "carlosjean090@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco end1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardie", "38220834", cli1, c1);
		Endereco end2 = new Endereco(null, "Avenida Matos", "105", "Apto 800", "Centro", "38777012", cli1, c2);
		Endereco end3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281777012", cli2, c2);
